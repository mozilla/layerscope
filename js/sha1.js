...
(function (sha1) {
	...
	if (bufferOrString instanceof Uint8Array ||
	    bufferOrString instanceof Int8Array ||
	    bufferOrString instanceof Uint16Array ||
	    bufferOrString instanceof Int16Array ||
	    bufferOrString instanceof Uint32Array ||
	    bufferOrString instanceof Int32Array ||
	    bufferOrString instanceof Float32Array)
	{
	    sourceArray = new Uint8Array(bufferOrString.buffer, bufferOrString.byteOffset, bufferOrString.byteLength);
        } else if (bufferOrString instanceof ArrayBuffer) {
            sourceArray = new Uint8Array(bufferOrString);
        } else {
            sourceArray = string2Uint8Array(String(bufferOrString));
        }
        var i, j, h0 = 1732584193, h1 = 4023233417, h2 = 2562383102, h3 = 271733878, h4 = 3285377520, sbytes = sourceArray.byteLength, sbits = sbytes << 3, minbits = sbits + 65, bits = Math.ceil(minbits / 512) << 9, bytes = bits >>> 3, slen = bytes >>> 2;
